...
export function FolderCard({
  ...
  return (
    ...
    >
      ...
      */}
      <div className="relative w-full h-full flex flex-col rounded-2xl rounded-tl-none border shadow-sm p-3 sm:p-5 mt-4 transition-colors bg-[#1A1832] border-[#2D2A4A] text-white hover:bg-[#25224a] hover:border-[#3d386b] dark:bg-card dark:border-border/60 dark:text-foreground dark:hover:bg-muted/50">
        
        {/* THE TAB */}
        <div className="absolute bottom-[100%] left-[-1px] h-4 w-[40%] min-w-[100px] border-t border-l rounded-t-xl z-0 bg-[#6D28D9] border-[#6D28D9] opacity-80 group-hover:opacity-100 dark:bg-muted dark:border-border/60 transition-colors" />
        
        {/* TOP SECTION: Icon & Disconnect Button */}
        <div className="flex items-start justify-between relative z-10 mb-3 sm:mb-4">
          <div className="flex h-9 w-9 sm:h-10 sm:w-10 items-center justify-center rounded-xl transition-colors flex-shrink-0 bg-[#6D28D9] text-white opacity-90 group-hover:opacity-100 dark:bg-brand/20 dark:text-brand">
        ...
        <div className="flex-1 space-y-0.5 sm:space-y-1 relative z-10 min-w-0 w-full">
          <div className="flex flex-col gap-1 sm:gap-2 w-full">
            <div className="flex items-start justify-between gap-1 sm:gap-2 w-full">
              <h3 className="text-[13px] sm:text-[15px] font-bold tracking-tight text-white dark:text-foreground leading-tight break-words flex-1 min-w-0">
                {repoName || title}
              </h3>
              <span
                className={cn(
          ...
          <p className="overflow-hidden text-ellipsis whitespace-nowrap text-[11px] sm:text-[12px] font-medium text-white/70 dark:text-muted-foreground w-full">
            {repoFullPath || fullName}
          </p>
          <p className="line-clamp-2 text-[11px] sm:text-[12px] text-white/70 dark:text-muted-foreground w-full">
            {lastCommitMessage || '—'}
          </p>
          <p className="flex items-center gap-0.5 sm:gap-1 text-[10px] sm:text-[12px] text-white/60 dark:text-muted-foreground overflow-hidden text-ellipsis whitespace-nowrap w-full">
          ...
          <p className="flex items-center gap-0.5 sm:gap-1 text-[10px] sm:text-[12px] text-white/60 dark:text-muted-foreground w-full">
        ...
        <div className="mt-4 sm:mt-6 flex items-center justify-between gap-2 relative z-10 min-w-0 w-full">
